export default function Marketplace() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-10">
      <h1 className="text-3xl font-bold text-gray-800 mb-6">Explore AI Tools</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {tools.map((tool, index) => (
          <div key={index} className="bg-white shadow-md rounded-lg overflow-hidden hover:shadow-lg transition">
            ...
            />
            <div className="p-5">
              <h3 className="text-xl font-semibold text-gray-800 mb-1">{tool.name}</h3>
              <p className="text-sm text-gray-600 mb-1">Category: {tool.category}</p>
              <p className="text-sm text-gray-600 mb-3">Price: {tool.price}</p>
